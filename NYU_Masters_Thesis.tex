...
\noindent\begin{minipage}{.45\textwidth}
\begin{lstlisting}[caption={P4 Variable Declarations} ,frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
...
\end{minipage}\hfill
\begin{minipage}{.45\textwidth}
\begin{lstlisting}[caption={Control Plane Initial Value Entries} ,frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
register_write reg1 0 4
register_write reg1 1 1
register_write reg1 2 8
register_write reg2 0 0
\end{lstlisting}
\begin{lstlisting}[caption=Transient Var Metadata Initialization,frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
parser parse_p {
    extract(p);
...
\begin{lstlisting}[caption=P4 Actions, frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
action action2 () {
...
\end{lstlisting}
\begin{lstlisting}[caption=P4 Ingress Control, frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
...
\end{lstlisting}
\begin{lstlisting}[caption=Control Plane Entries, frame=tlrb, basicstyle=\linespread{1.3}\scriptsize]{Name}
