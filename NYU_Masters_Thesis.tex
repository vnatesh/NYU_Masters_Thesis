...
the programmable Open vSwitch~\cite{vsw} platform to more recent research projects that
implement packet scheduling~\cite{sched}, measurement~\cite{meas}, and application offload of niche
applications on programmable switches~\cite{offl}.
